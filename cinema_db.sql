...
CREATE TABLE `orders` (
  ...
  `normal_ticket_quantity` int(11) NOT NULL,
  `student_ticket_quantity` int(11) NOT NULL,
...
(63, 4, 8, '2023-12-22 12:34:35', 'english'),
(64, 4, 9, '2023-12-20 12:34:58', 'english'),
(65, 3, 2, '2023-12-21 12:34:58', 'polish'),
(68, 4, 1, '2023-12-20 23:14:37', 'english'),
(69, 4, 8, '2023-12-20 23:14:37', 'polish'),
(70, 3, 4, '2023-12-21 20:15:36', 'italian'),
(71, 3, 9, '2023-12-23 12:15:36', 'russian'),
(72, 3, 2, '2023-12-21 23:28:09', 'polish'),
(73, 4, 9, '2023-12-20 23:28:09', 'spanish'),
(74, 4, 7, '2023-12-20 15:26:08', 'english'),
(75, 3, 8, '2023-12-20 15:26:08', 'italian');
...
--
ALTER TABLE `orders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=960028588;
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`showing_id`) REFERENCES `showing` (`id`);
